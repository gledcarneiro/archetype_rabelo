...
public class ${artifactId}Socket {
	...
	public ${artifactId}Socket() {
		try {
			...
			System.out.println("Cliente fechou conex�o.");
	...
	/*
	 * public static void main(String args[]) { ${artifactId}Socket app = new
	 * ${artifactId}Socket();
